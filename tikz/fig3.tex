...
\begin{tikzpicture}[scale=2.3, auto, swap]
    ...
    \node at (3,-.27) {\includegraphics[width=0.35\textwidth]{images_tikz/plot_DD_EPR.png}};
    \node at (2.1,.72) {(c)};
    
    \node at (4.86,-.27) {\includegraphics[width=0.35\textwidth]{images_tikz/plot_DD_Dxt.png}};
    \node at (4,.72) {(d)};
